...
download_notify() {
        ...
        if [[ -f $(basename "${urls[0]}") ]] && [[ $1 != "Ryujinx" ]] && [[ $1 != "Cemu" ]] && [[ $1 != "Panda3DS" ]] && [[ $1 != "DolphinDev" ]] && [[ $1 != "RMG" ]] && [[ $1 != "melonDS" ]] && [[ $1 != "SkyEmu" ]] && [[ $1 != "mGBAdev" ]] && [[ $1 != "Sudachi" ]] && [[ $1 != "Lime3DS" ]] && [[ $1 != "citraPMK7" ]] && [[ $1 != "Citra-Enhanced" ]]; then
                ...
                case $1 in
                        ...
                        Lime3DS)
                                curl -L -o ~/Applications/Lime3DS.tar.gz -z ~/Applications/Lime3DS.tar.gz "${urls[0]}" && mkdir ~/Applications/Lime3DS && tar xf Lime3DS.tar.gz -C ~/Applications/Lime3DS --strip-components=1 && chmod +x ~/Applications/Lime3DS/lime3ds-cli.AppImage && chmod +x ~/Applications/Lime3DS/lime3ds-gui.AppImage && chmod +x ~/Applications/Lime3DS/lime3ds-room.AppImage
                                ;;
